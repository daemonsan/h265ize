...
class Video {
    ...
    encode() {
        ...
        return new Promise(function(resolve, reject) {
            ...
            // wScale video
            if (_self.options.wscale)
                //_self.ffmpegCommand.videoFilters('scale=-1:' + _self.options.scale);
                _self.ffmpegCommand.videoFilters('scale=' + _self.options.wscale + ':-2');
            // vScale video
            if (_self.options.vscale)
                _self.ffmpegCommand.videoFilters('scale=-2:' + _self.options.vscale);
                //_self.ffmpegCommand.videoFilters('scale=' + _self.options.scale + ':-2');                
