...
function getCLIArguments() {
    return yargs
        ...
        .options({
            ...
            'wscale': {
                default: userSettings['wscale'] || false,
                describe: 'Width videos should be scaled to. Videos will always maintain original aspect ratio. [Examples: 720, 480]',
                type: 'number',
                group: 'Video:'
            },
            'vscale': {
                default: userSettings['vscale'] || false,
                describe: 'Height videos should be scaled to. Videos will always maintain original aspect ratio. [Examples: 720, 480]',
                type: 'number',
                group: 'Video:'
            },
            'debug': {
